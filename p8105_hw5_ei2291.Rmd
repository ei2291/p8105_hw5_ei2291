...
```
Based on the output, about 64.6% with a 95% CI (0.63 to 0.66) of homicides in baltimore are unsolved.
...
Based on the plot we see that there is a range in the proportion of unsolved homicides. Some city have low proportion(e.g.Richmond,VA), while others have higher unsolved proportions(e.g.Chicago, IL).Overall though many cities have around 40 to 60% of unsolved homicide proportions. 
